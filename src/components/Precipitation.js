...
const Precipitation = ({ unit, value }) => {
  return (
    <>
        ...
        <div className="flex justify-between  mt-2">
          <div className="w-full">
            <div className="flex justify-between">
              ...
              <h1 className="font-light text-gray-700 text-xs">60</h1>
              <h1 className="font-light text-gray-700 text-xs">70</h1>
              <h1 className="font-light text-gray-700 text-xs">80</h1>
              <h1 className="font-light text-gray-700 text-xs">90</h1>
            </div>
